...
| `evidence_101` (T2) | NOT-PASS | not-fluent | 2026-07-16 | yes ³ | unverified | base-rate neglect — genuine K gap (deliberated → still wrong); a T2 mode the original assessment never covered |
