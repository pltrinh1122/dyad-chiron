...
| `evidence_101` (T2) | NOT-PASS | not-fluent | 2026-07-16 | yes ³ | unverified | base-rate-as-prior — a positive with few false-positives updates P *upward*; overcorrected to reflexive "base rate mentioned → unsound", missing the high-base-rate SOUND case (re-test #2) |
