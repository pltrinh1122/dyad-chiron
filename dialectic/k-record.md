...
| `falsifiability_101` (T1) | PASS | partially-fluent | 2026-07-11 | partial ² | unverified | fluency (effortful pass; refresh opted-in) |
...
² Round 1 was gameable (qualification→U surface cue) → fixed and re-run in Round 2; not a fully-blind sitting.
