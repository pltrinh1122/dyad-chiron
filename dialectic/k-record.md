...
² Re-verified 2026-07-19 by a **fully-blind spaced re-test** — 3 fresh items, help OFF, 8 days after the 2026-07-11 pass: **3/3 correct**, so durability is now **verified**. (Prior sittings were not fully blind — Round 1 was gameable [qualification→U cue], re-run in Round 2.) Fluency held at **partially-fluent**: item 2 imported a T2 evidence-quality caveat (randomization) instead of naming the refuter, so falsifiability isn't yet fully de-conflated from evidence-soundness under automatic recall.
